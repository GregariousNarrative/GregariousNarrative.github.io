...
class Boid {
  ...
  constructor(boid) {
    ...
    this.radius = boid.radius * 1;
    this.introversionCoefficient = 1;
    this.introversion = 1;
    this.quicknessCoefficient = 1;
    this.quickness = 5;
    this.racismCoefficient = 0;
    this.racism = 0;
    this.color = "#f9d909";
   ...
   */
  draw(){
    c.drawImage(birdImg, this.position.x, this.position.y, 50, 50);
    // c.beginPath();
